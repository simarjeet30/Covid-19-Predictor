...
echo "<form name='dataentry' method='post' action='entry.php'>
...
$rows=$rows+1;
$un=$_SESSION['uid'];
$res=mysqli_query($conn, "INSERT INTO patientdata (row_names,id,gender, age, heart_rate, temperature, SpO2_saturation) VALUES ('$un','$rows', '$_POST[gen]', '$_POST[age]', '$_POST[hr]', '$_POST[tem]', '$_POST[sp]')");
